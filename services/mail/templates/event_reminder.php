<div style="text-align: center; margin-bottom: 24px;">
    <span style="background-color: #fff7ed; color: #c2410c; padding: 6px 14px; border-radius: 9999px; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em;">
        Event Reminder
    </span>
</div>

<h2 style="color: #0f172a; margin: 0 0 16px 0; font-size: 24px; font-weight: 700; text-align: center;">Upcoming Event</h2>

<p style="font-size: 16px; line-height: 1.6; color: #475569; margin-bottom: 24px;">
    Hi <?= $user['name'] ?? "" ?>, this is a friendly reminder for an event on your family calendar.
</p>
...
<div style="background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; padding: 0; overflow: hidden; margin-bottom: 24px;">
    <div style="background-color: #f97316; padding: 16px; text-align: center;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="padding: 8px 0; font-size: 14px; color: #1e293b; font-weight: 600;">
                    <?= date('F j, Y', strtotime($event['start'] ?? "")) ?><br>
...
<p style="font-size: 14px; color: #64748b; text-align: center; margin-bottom: 32px;">
    We've attached the calendar invite (.ics) again for your convenience.
</p>
