                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                                        ...
                                        <input type="text" class="form-control border-0 py-2" id="nickname" name="nickname" placeholder="Enter nickname" value="<?php echo htmlspecialchars($user['nickname'] ?? ''); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                                        ...
                                        <input type="email" class="form-control border-0 py-2" id="email" name="email" placeholder="email@example.com" value="<?php echo htmlspecialchars($user['email']); ?>">
                                    </div>
                                </div>
