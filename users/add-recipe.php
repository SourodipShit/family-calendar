...
<div id="page-content-wrapper" class="flex-grow-1 bg-white">
    ...
    <div class="container-fluid all-width-sames p-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 class="fw-bold mb-0">Create New Recipe</h4>
        </div>
                        ...
                        <form id="add-recipe-form" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                                                    ...
                                                    <input type="text" name="name" class="form-control border-0 py-2" placeholder="e.g. Grilled Salmon" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                                                    ...
                                                    <input type="number" name="servings" class="form-control border-0 py-2" placeholder="4">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                                                    ...
                                                    <input type="number" name="prep_time_min" class="form-control border-0 py-2" placeholder="10">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                                                    ...
                                                    <input type="number" name="cook_time_min" class="form-control border-0 py-2" placeholder="20">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-semibold">Visibility</label>
                                                <div class="btn-group w-100 shadow-sm rounded-3 overflow-hidden border" role="group">
                                                    <input type="radio" class="btn-check" name="visibility" id="vis-public" value="public" autocomplete="off">
                                                    ...
                                                    <input type="radio" class="btn-check" name="visibility" id="vis-private" value="private" autocomplete="off" checked>
                                            ...
                                            <div class="col-12 mt-2">
                                                ...
                                                <div class="d-flex flex-wrap gap-2" id="additional-images-container">
                                                    <div class="upload-box border rounded-3 d-flex align-items-center justify-content-center bg-light cursor-pointer shadow-sm" style="width: 80px; height: 80px; border: 2px dashed #dee2e6 !important;" onclick="document.getElementById('additional-images-input').click();">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="border rounded-4 d-flex flex-column align-items-center justify-content-center p-3 bg-light cursor-pointer text-center shadow-sm" style="border: 2px dashed #dee2e6 !important; height: 200px;" onclick="document.getElementById('imageInput').click();">
                                            <i class="fa-solid fa-camera text-secondary display-6 mb-2"></i>
                                            <p class="mb-0 small fw-medium text-muted">Upload Cover Photo</p>
                                            <input type="file" id="imageInput" name="recipe_image" class="d-none" accept="image/*">
                                            <img id="recipe-preview" src="#" alt="Preview" class="d-none w-100 h-100 object-fit-cover rounded-3" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="steps-container">
                                    <div class="dynamic-row border rounded-4 p-3 mb-3 shadow-sm bg-light step-item-row">
                                        <div class="d-flex gap-3 align-items-start mb-3">
                                            <span class="badge rounded-circle bg-primary p-2 step-number" style="width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">1</span>
                                            <textarea name="instruction[]" class="form-control border-0 bg-transparent py-0" rows="2" placeholder="Describe this step in detail..." required></textarea>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="input-group input-group-sm border rounded-2 bg-white">
                                                    ...
                                                    <input type="text" name="equipment[]" class="form-control border-0" placeholder="Equipment (e.g. Pan)">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-group input-group-sm border rounded-2 bg-white">
                                ...
                                <div id="ingredients-container">
                                    <div class="row g-2 mb-3 align-items-end ingredient-item-row">
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="ingredient_qty[]" class="form-control form-control-sm border rounded-2 shadow-sm" placeholder="2">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label extra-small fw-semibold text-muted mb-1">Unit</label>
                                            <input type="text" name="ingredient_unit[]" class="form-control form-control-sm border rounded-2 shadow-sm" placeholder="pcs">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label extra-small fw-semibold text-muted mb-1">Ingredient Name</label>
                                            <input type="text" name="ingredient_name[]" class="form-control form-control-sm border rounded-2 shadow-sm" placeholder="Fresh Salmon" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label extra-small fw-semibold text-muted mb-1">Notes</label>
                                            <input type="text" name="ingredient_notes[]" class="form-control form-control-sm border rounded-2 shadow-sm" placeholder="Skin on">
                                        </div>
                            ...
                            <div class="step-content" id="step-4">
                                ...
                                <div class="row g-4 mb-4">
                                    <div class="col-md-3">
                                        <div class="bg-light rounded-4 p-3 text-center border shadow-sm">
                                            ...
                                            <input type="number" step="0.1" name="calories" class="form-control border-0 bg-transparent text-center fw-bold fs-4 p-0" value="0">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="bg-light rounded-4 p-3 text-center border shadow-sm">
                                            <label class="extra-small fw-bold text-success mb-1 d-block">PROTEIN (g)</label>
                                            <input type="number" step="0.1" name="protein" class="form-control border-0 bg-transparent text-center fw-bold fs-4 p-0" value="0">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="bg-light rounded-4 p-3 text-center border shadow-sm">
                                            <label class="extra-small fw-bold text-warning mb-1 d-block">CARBS (g)</label>
                                            <input type="number" step="0.1" name="carbs" class="form-control border-0 bg-transparent text-center fw-bold fs-4 p-0" value="0">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="bg-light rounded-4 p-3 text-center border shadow-sm">
                                            <label class="extra-small fw-bold text-danger mb-1 d-block">FAT (g)</label>
                                            <input type="number" step="0.1" name="fat" class="form-control border-0 bg-transparent text-center fw-bold fs-4 p-0" value="0">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group border rounded-4 overflow-hidden shadow-sm mb-4">
                                    <textarea name="variations_notes" class="form-control border-0 py-3" rows="4" placeholder="Share tips, variations, or serving suggestions..."></textarea>
                                </div>
                            </div>
