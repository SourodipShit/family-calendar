        ...
        <div class="col-lg-6 d-none d-lg-flex flex-column justify-content-center align-items-center left-panel">
            <div class="brand-content">
                ...
                <div class="illustration-container mt-4 mb-5">
                    <?php $img_src = !empty($page_image) ? str_replace('../', $path_prefix, $page_image) : 'https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&q=80&w=800'; ?>
            ...
            <div class="login-form-wrapper" style="max-width: 450px;">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <div class="bg-light rounded-pill p-1 d-inline-flex" style="border: 1px solid var(--border-color);">
                        <a href="signup.php" class="btn btn-sm rounded-pill fw-medium px-4 btn-primary text-white text-decoration-none" style="transition: all 0.2s;">Family Head</a>
                        <a href="coach_signup.php" class="btn btn-sm rounded-pill fw-medium px-4 text-muted text-decoration-none" style="transition: all 0.2s;">Coach</a>
                    </div>
                </div>
                ...
                <form id="signupForm" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="step-content active" id="step-1">
                        ...
                        <div class="mb-4 form-check">
                            <input type="checkbox" class="form-check-input" id="sms_optin" name="sms_optin" required>
                            <label class="form-check-label text-muted small" for="sms_optin" style="line-height: 1.4;">
                                By signing up, you agree to receive SMS notifications from iS4B Family Calendar. Msg frequency varies. Msg & data rates may apply. Reply STOP to opt out or HELP for help. See our <a href="agreement.php?type=opt_in_agreement" target="_blank" class="text-primary text-decoration-none fw-medium">Opt-In/Out Policy</a> for details.
                            </label>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnNext.addEventListener('click', function() {
            ...
            const smsOptin = document.getElementById('sms_optin').checked;
            ...
            if(!smsOptin) {
                if(typeof showAlert === 'function') {
                    showAlert('You must agree to receive SMS notifications to continue.', 'error');
                } else {
                    alert('You must agree to receive SMS notifications to continue.');
                }
                return;
            }
