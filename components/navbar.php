...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom px-4 py-3">
    ...
    <div class="ms-auto rights-menus d-flex align-items-center gap-3 gap-md-4">
        ...
        <div class="d-flex align-items-center fw-bold d-none d-md-flex">
            <svg xmlns="http://www.w3.org/2000/svg" class="me-2" viewBox="0 0 24 24" width="26" height="26"
                fill="rgba(254,186,9,1)">
                <path
